...
public class Robot extends IterativeRobot {
	...
	public void setDashboard() {
		...
		SmartDashboard.putNumber("Front Left Motor Output Current",
				talonInfo[0][0]);
		SmartDashboard.putNumber("Front Right Motor Output Current",
				talonInfo[1][0]);
		SmartDashboard.putNumber("Rear Left Motor Output Current",
				talonInfo[2][0]);
		SmartDashboard.putNumber("Rear Right Motor Output Current",
				talonInfo[3][0]);

		SmartDashboard.putNumber("Front Left Motor Temperature",
				talonInfo[0][1]);
		SmartDashboard.putNumber("Front Right Motor Temperature",
				talonInfo[1][1]);
		SmartDashboard
				.putNumber("Rear Left Motor Temperature", talonInfo[2][1]);
		SmartDashboard.putNumber("Rear Right Motor Temperature",
				talonInfo[3][1]);

		SmartDashboard.putNumber("Drive Gyro", m_robotMap.m_drive.getGyro());

		SmartDashboard.putNumber("Craaa Output Current",
				m_robotMap.m_craaa.getCANTalon());
		SmartDashboard.putNumber("Craaa Temp",
				m_robotMap.m_craaa.getCANTalonHeat());
		SmartDashboard.putNumber("Lift Temp",
				m_robotMap.m_lift.getCANTalonHeat());
		SmartDashboard.putNumber("Lift Output Current",
				m_robotMap.m_lift.getCANTalon());
		...
		SmartDashboard
				.putNumber("Lift Encoder", m_robotMap.m_lift.getEncoder());
		/*
